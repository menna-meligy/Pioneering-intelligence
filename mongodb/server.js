...
var db_1 = require("../mongoConfig/db");
...
app.post("/api/messages", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, question, answer, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, messageService_1.saveMessageData)(question, answer)];
            case 2:
                // Call the saveMessageData function to save the message data
                _b.sent();
...
app.post("/api/save-message", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, question, answer, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, question = _a.question, answer = _a.answer;
            ...
            case 3:
                error_2 = _b.sent();
                console.error("Error saving message data:", error_2);
                res.status(500).json({ error: "Internal Server Error" });
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
